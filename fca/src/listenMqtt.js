...
module.exports = function (defaultFuncs, api, ctx) {
    ...
    getSeqID = function getSeqID() {
        ...
        defaultFuncs
            ...
            .then(utils.parseAndCheckLogin(ctx, defaultFuncs))
            .then((resData) => {
                if (utils.getType(resData) != "Array") throw { error: "Can't Log In - Appstate Has Error", res: resData };
            ...
            .catch((err) => {
                ...
                if (utils.getType(err) == "Object" && err.error === "Can't Log In - Appstate Has Error") ctx.loggedIn = false;
